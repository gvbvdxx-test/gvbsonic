...
var scripts = [
	...
	//This is used to store data and read data.
	
	"src/save-data.js?n=1",
...
if (isElectron) { //This is what happens when you start the game in Electron JS.
	...
	if (window.location.href.startsWith("file://")) {
		window.alert("This game must be loaded over a URL. The game cannot run directly from your filesystem.");
	} else {
